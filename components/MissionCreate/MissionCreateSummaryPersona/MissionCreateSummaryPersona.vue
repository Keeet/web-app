<template>
  <div class="mission-create-summary-persona">
    <p class="mission-create-summary-persona-headline">
      Persona
    </p>
    <div class="mission-create-summary-persona-body">
      ...
      <div class="mission-create-summary-persona-info">
        ...
        <table class="mission-create-summary-persona-info-table">
          <tbody>
            <tr>
              <td>Gender:</td>
...
export default {
  name: 'MissionCreateSummaryPersona',
...
<style scoped lang="scss">
  @import "MissionCreateSummaryPersona";
</style>
