...
export default {
  name: 'MissionSurveyResultsItem',
  components: {
    MissionSurveyResultsItemText,
    MissionSurveyResultsItemBarsHorizontal,
    MissionSurveyResultsItemBarsVertical,
    MissionSurveyResultsItemFirstClick,
